        ...
        <div id="layoutAuthentication" class="mx-auto">
            <div id="layoutAuthentication_content">
                <main>
                    ...
                    <header>
                        <div class="navbar-container" id="navbar-container">
                            <div class="navbar-header">
                                <img src="<?=base()?>assets/image/sd.png" class="img-responsive navbar-brand"><a href='../koperasi/index.php' class="navbar-brand">Koperasi Sekolah Dasar</h5>
                            ...
                            <div class="collapse navbar-collapse mr-48">
                                <ul class="nav navbar-nav navbar-right">
                                    <li><a class="ml-7 text-medium" id="pesan_sedia" data-bs-toggle="modal" data-bs-target="#modalpesan" style="cursor:pointer;">
                                        <span class='glyphicon glyphicon-comment mx-auto mr-2'></span>  Pesan</a></li>
                                        <li class="dropdown"><a class="dropdown-toggle" data-bs-toggle="dropdown" role="button"> 
                                        &nbsp&nbsp<span class="glyphicon glyphicon-user mt-auto -mr-2 -mt-6" id="dropbtn" onclick="myFunction()"></span></a>
                                        <div id="myDropdown" class="dropdown-content">
                                            ...
                                            if($_SESSION['member'] == 1){
                                                ...
                                                ?>
                                                <a role="button">Hi, <?php echo $_SESSION["username"]; ?></a>
                                                <a href="../dashboard/edit.php?id_user=<?php echo $_SESSION["id_user"];?>" class="fa fa-user mr-5"> Account</a>
                                                <a href="header.php?aksi=keluar"><i class="fa fa-sign-out mr-4"></i>Log out</a>
                                                <?php
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <img src="<?=base()?>assets/image/sd.png" alt="logo koperasi" class="navbar-brand">
                                        <h4 class="modal-title text-medium fw-lighter">Pesan Notification</h4>
                                        <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button>
                                    </div>
                                    <div class="modal-body">
                                        <?php
                                        $periksa = mysqli_query($conKoperasi, "SELECT * FROM t_databarang WHERE jumlah_barang <= 0");
                                        if($x = mysqli_fetch_array($periksa)){
                                            if($x['jumlah_barang']<=0){
                                                echo "<div style='padding:5px' class='alert alert-warning'><span class='glyphicon glyphicon-info-sign'></span> Stok  
                                                <a style='color:red'>". $x['kode_barang'] ." dan ". $x['nama_barang'] ."</a> sudah habis. silahkan di isi kembali product !!</div>";	
                                            }
                                        }
                                        ?>
                                    </div>
                                    <div class="modal-footer">
				        	            <button type="button" class="active active-default" data-bs-dismiss="modal">Batal</button>						
				                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 mt-1 ml-10">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="dropdown-k text-small-3 active" id="smalls">
                                <a href="javascript:void(0)" class="text-small-3 text-start mb-7" id="dropbtn-k" onclick="myFunction_Koperasi()"><span class="fa fa-shopping-cart mr-4"></span> 
                                Koperasi Sekolah</a>
                            ...
                            <a href="javascript:void(0)" class="text-small-3 text-start mb-7" id="dropbtn-p" onclick="myFunction_Perpus()"><span class="fa fa-book mr-4"></span> 
                            ...
                            <li class="dropdown-g text-small-3 active" id="smalls">
                                <a href="javascript:void(0)" role="button" class="text-small-3 text-start mb-7" id="dropbtn-g" onclick="myFunction_Data()"><span class="fa fa-file  mr-5"></span>
                                Data Sekolah</a>
                                <div id="myDropdowng" class="dropdown-content">
                                    <a href="../dashboard/full_mapel.php"><span class="fa fa-book"></span> Mata Pelajaran</a>
