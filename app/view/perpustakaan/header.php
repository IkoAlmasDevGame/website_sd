                    ...
                    <header>
                        <div class="navbar-container" id="navbar-container">
                            <div class="navbar-header">
                                <img src="<?=base()?>assets/image/sd.jpeg" class="img-responsive navbar-brand"><a href='../perpustakaan/index.php' class="navbar-brand">Perpustakaan Sekolah Dasar</h5>
                            ...
                            <div class="collapse navbar-collapse mr-48">
                                <ul class="nav navbar-nav navbar-right">
                                    <li><a class="ml-7 text-medium" id="pesan_sedia" data-bs-toggle="modal" data-bs-target="#modalpesan" style="cursor:pointer;">
                                        ...
                                        &nbsp&nbsp<span class="glyphicon glyphicon-user -mr-2 -mt-6" id="dropbtn" onclick="myFunction()"></span></a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <img src="<?=base()?>assets/image/sd.png" alt="logo perpustakaan" class="navbar-brand">
                                        <h4 class="modal-title text-medium fw-lighter">Pesan Notification</h4>
                                        <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button>
                                    </div>
                                    <div class="modal-body">
                                        <?php
                                        $periksa = mysqli_query($conPerpustakaan, "SELECT * FROM t_databuku WHERE jumlah_buku <= 0");
                                        if($x = mysqli_fetch_array($periksa)){
                                            if($x['jumlah_buku'] <= 0){
                                                ...
                                                <a style='color:green'>". $x['nama_buku'] ."</a> sudah habis. silahkan di isi kembali Buku Perpustakaan !!</div>";	
                                            }
                                        }
                                        ?>
                                    </div>
